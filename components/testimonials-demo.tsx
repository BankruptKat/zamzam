      ...
      <div className="container z-10 mx-auto px-4 md:px-8">
        ...
        >
          <div className="flex justify-center">
            <div className="rounded-lg border border-white/15 px-4 py-1 text-sm text-white/85">Testimonials</div>
          </div>
          <h2 className="mt-5 text-xl font-bold tracking-tighter text-white sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl">
            What our clients say
          </h2>
          <p className="mt-5 text-center text-white/70">See what homeowners say about our craftsmanship and service.</p>
        </motion.div>

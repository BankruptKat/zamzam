        ...
        <>
                ...
                <div className="relative z-10 flex min-h-[70vh] items-end px-4 pb-20 pt-32 md:px-8 md:pb-32">
                    <div className="mx-auto w-full max-w-6xl">
                        ...
                        <BlurFade delay={0.3} duration={1.2} blur="12px">
                            <h1 className="mt-6 max-w-4xl text-4xl font-semibold leading-[0.95] text-neutral-50 md:text-6xl lg:text-7xl">
                                Built on Precision.
                                <br />
                                <span className="text-neutral-200">Committed to Quality.</span>
                            </h1>
                        </BlurFade>
                    </div>
                </div>
                ...
                <div className="mx-auto w-full max-w-6xl">
                    <div className="grid gap-12 md:grid-cols-2 md:gap-20">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <p className="text-xs font-medium uppercase tracking-[0.2em] text-[#9b4f34] dark:text-[#f4c3ad]/70">Philosophy</p>
            ...
            <section className="border-t border-white/5 px-4 py-24 md:px-8 md:py-32">
                <div className="mx-auto w-full max-w-6xl">
                    ...
                    >
                        <p className="text-xs font-medium uppercase tracking-[0.2em] text-[#9b4f34] dark:text-[#f4c3ad]/70">Standards</p>
                        <h2 className="mt-4 text-center text-3xl font-semibold text-slate-900 dark:text-white md:text-4xl">
            ...
            <section className="border-t border-white/5 px-4 py-24 md:px-8 md:py-32">
                <SectionReveal className="mx-auto w-full max-w-4xl text-center">
                    <p className="text-xs font-medium uppercase tracking-[0.2em] text-[#9b4f34] dark:text-[#f4c3ad]/70">Begin Your Project</p>

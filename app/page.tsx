  ...
  return (
    <>
      ...
      <section className="hero-content relative min-h-[100vh] overflow-hidden">
        ...
        <div className="relative z-10 flex min-h-[100dvh] items-center px-4 pb-12 pt-32 md:px-8">
          <div className="mx-auto w-full max-w-6xl text-center md:text-left">
            ...
            <BlurFade delay={0.3} duration={1.2} blur="12px">
              <h1 className="mx-auto mt-6 max-w-4xl text-[2.6rem] sm:text-[3.2rem] font-semibold leading-[1.05] tracking-tight text-neutral-50 md:mx-0 md:text-[5rem] md:leading-[0.95] lg:text-[6rem]">
                Precision Masonry
                <br />
            ...
            <BlurFade delay={0.5} duration={1} blur="12px">
              <p className="mx-auto mt-8 max-w-md text-[17px] leading-[1.65] text-neutral-200/90 md:mx-0 md:mt-10 md:text-lg">
            ...
            <BlurFade delay={0.9} duration={0.8} blur="8px">
              <p className="mt-6 text-[13px] text-neutral-300/70 md:mt-8 md:text-xs">
      ...
      <section className="px-4 pb-20 pt-16 md:px-8 md:py-32">
        <SectionReveal className="mx-auto flex w-full max-w-6xl flex-col items-center justify-center">
          ...
          <p className="mt-2 max-w-xl text-center text-[17px] leading-[1.65] text-slate-500 dark:text-white/55 md:text-lg">
            Architectural masonry and chimney work for discerning homeowners.
          </p>
        </SectionReveal>

        <div className="mx-auto mt-10 grid w-full max-w-5xl gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <SectionReveal className="mx-auto mt-12 flex w-full max-w-6xl justify-center">
          <Link href="/services" className="text-[15px] font-medium text-[#f4c3ad] hover:text-[#ffd3bf] transition-colors md:text-sm">
            View All Services
          </Link>
        </SectionReveal>
      </section>
      ...
      <section className="py-16 md:py-32">
        ...
        <div className="mt-14 overflow-x-auto scroll-snap-x snap-mandatory px-4 md:px-8 pb-4 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden flex gap-4 md:gap-5 scroll-p-4 md:scroll-p-8">
          {[
            {
            ...
            <article
              key={project.title}
              className="group relative w-[85vw] max-w-[340px] flex-shrink-0 snap-center md:snap-start overflow-hidden rounded-2xl md:w-[360px]"
            >
